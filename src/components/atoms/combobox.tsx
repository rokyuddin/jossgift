...
function ComboboxSeparator({
  ...
  return (
    <ComboboxPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 bg-border/50 h-px", className)}
      {...props}
    />
  )
}
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn("flex flex-wrap items-center gap-1.5 bg-input/30 bg-clip-padding px-2.5 has-data-[slot=combobox-chip]:px-1.5 py-1.5 border border-input has-aria-invalid:border-destructive focus-within:border-ring dark:has-aria-invalid:border-destructive/50 rounded-4xl has-aria-invalid:ring-[3px] has-aria-invalid:ring-destructive/20 focus-within:ring-[3px] focus-within:ring-ring/50 dark:has-aria-invalid:ring-destructive/40 min-h-9 text-sm transition-colors", className)}
      {...props}
    />
  )
}
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "flex justify-center items-center gap-1 bg-muted-foreground/10 has-disabled:opacity-50 px-2 has-data-[slot=combobox-chip-remove]:pr-0 rounded-4xl w-fit h-[calc(--spacing(5.5))] font-medium text-foreground text-xs whitespace-nowrap has-disabled:cursor-not-allowed has-disabled:pointer-events-none",
        className
      )}
      {...props}
    >
