...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex gap-2 has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10 group-data-[disabled=true]/field:opacity-50 [&>*]:data-[slot=field]:p-4 has-[>[data-slot=field]]:border has-data-checked:border-primary/50 has-[>[data-slot=field]]:rounded-xl w-fit leading-snug",
