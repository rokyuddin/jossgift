            ...
            <LegalSection title="3. Types of Cookies We Use">
                <div className="space-y-8">
                    <div className="space-y-2">
                        <h3 className="font-medium text-foreground text-xl">Essential Cookies</h3>
                    ...
                    <div className="space-y-2">
                        <h3 className="font-medium text-foreground text-xl">Performance & Analytics Cookies</h3>
                    ...
                    <div className="space-y-2">
                        <h3 className="font-medium text-foreground text-xl">Functionality Cookies</h3>
                        <p>These cookies allow our website to remember choices you make and provide enhanced, more personal features.</p>
                    </div>
                    <div className="space-y-2">
                        <h3 className="font-medium text-foreground text-xl">Targeting & Advertising Cookies</h3>
